...
function setupDatGui() {
    ...
    var coordSystem = gui1.add(_params, 'XMapping', ['gR', 'gI', 'fR', 'fI']);
    var coordSystem = gui1.add(_params, 'YMapping', ['gR', 'gI', 'fR', 'fI']);
    var coordSystem = gui1.add(_params, 'ZMapping', ['gR', 'gI', 'fR', 'fI']);
    var coordSystem = gui1.add(_params, 'GradientMapping', ['gR', 'gI', 'fR', 'fI']);
    gui1.add(_params, 'XMin').listen();
    gui1.add(_params, 'XMax').listen();
    gui1.add(_params, 'YMin').listen();
    gui1.add(_params, 'YMax').listen();
    gui1.add(_params, 'ZMin').listen();
    gui1.add(_params, 'ZMax').listen();
    gui1.add(_params, 'GradientMin').listen();
    gui1.add(_params, 'GradientMax').listen();
    ...
    gui1.add(_params, 'helpComplex').name("Help.");
