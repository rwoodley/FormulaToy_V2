<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplexApp.aspx.cs" Inherits="Formula3DApp.ComplexApp" %>
<!DOCTYPE html>
...
<script>
    ...
    ga('send', 'pageview');
		...
		<script src="Complex/guiStuff.js"></script>
		<script src="FormulaValidationCommon.js"></script>
		<script src="Complex/FormulaValidation.js"></script>
		<script src="Complex/params.js"></script>
        <script>
	...
	<body>
        ...
        <div style="position: fixed; bottom: 0; width:95%; ">
            <div style="float: right; ">
                 ...
                 <span style="display:block;height:30px;color:white;"><nobr>Copyright (c) <a href="http://rwoodley.org/" style="color:#0000ff;" target="_blank">Robert Woodley</a> 2014-2016</nobr></span>
            </div>
        </div>
		<script src="Complex/Main.js"></script>
	</body>
</html>